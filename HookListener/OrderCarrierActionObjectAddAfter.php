...
class OrderCarrierActionObjectAddAfter extends AbstractHookListenerImplementation
{
    protected MarketplaceCore $core;
    protected MarketplaceSellerOrderManager $sellerOrderManager;
    protected CommandBusInterface $commandBus;

    public function __construct(
        MarketplaceCore $core,
        CommandBusInterface $commandBus,
        MarketplaceSellerOrderManager $sellerOrderManager
    ) {
        $this->core = $core;
