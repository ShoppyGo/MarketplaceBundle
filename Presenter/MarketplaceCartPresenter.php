...
namespace ShoppyGo\MarketplaceBundle\Presenter;
...
class MarketplaceCartPresenter
{
    /**
     * @var PriceFormatter
     */
     ...
     * @throws \Exception
     */
    public function present($cart, $refresh = false, $shouldSeparateGifts = false,)
    {
        if (!is_a($cart, 'Cart')) {
        ...
        if ($shouldSeparateGifts) {
            ...
            $rawProducts = $cart->getProducts($refresh);
        }
